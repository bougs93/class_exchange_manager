  ...
  Widget build(BuildContext context) {
    ...
    return Positioned.fill(
      ...
      child: IgnorePointer(
        ...
        child: ExchangedStatusSymbol(type: type),
...
class ExchangedStatusSymbol extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomPaint(
      ...
      painter: ExchangedStatusPainter(type: type),
...
class ExchangedStatusPainter extends CustomPainter {
  ...
  void _paintTakenClassCircle(Canvas canvas, Size size, Offset center) {
    ...
    final ringPaint = Paint()
      ...
      ..color = _takenClassSymbolColor.withValues(alpha: _takenClassSymbolAlpha)
