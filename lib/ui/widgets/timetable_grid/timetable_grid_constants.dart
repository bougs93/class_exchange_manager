...
class ArrowConstants {
  ...
  // 2중 교체 단방향에서 1번 그룹(1단계) 화살표를 셀 모서리를 따라 이동시켜
  // 2번 그룹과 겹치지 않게 하는 오프셋 (그리드 배율 적용 전 기준, px)
  static const double dualFirstGroupOffsetX = 7.0;
  static const double dualFirstGroupOffsetY = 7.0;
