...
class SelectedTeacherDestinationBorderExample {
  ...
  static void printCurrentSettings() {
    ...
    AppLogger.exchangeInfo(
      '테두리 색상: ${SimplifiedTimetableTheme.selectedTeacherDestinationBorderColor}',
    );
    AppLogger.exchangeInfo(
      '테두리 표시 여부: ${SimplifiedTimetableTheme.showSelectedTeacherDestinationBorder}',
    );
  }
  ...
  static void showHowToChangeBorderColor() {
    ...
    AppLogger.exchangeInfo(
      '1. lib/utils/simplified_timetable_theme.dart 파일을 열어주세요.',
    );
    AppLogger.exchangeInfo('2. 다음 상수를 찾아주세요:');
    AppLogger.exchangeInfo(
      '   static const Color selectedTeacherDestinationBorderColor = Color(0xFFFF0000);',
    );
...
class SelectedTeacherDestinationBorderExampleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('선택된 교사가 이동할 목적지 셀 테두리 색상 상수 예시')),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed:
                  SelectedTeacherDestinationBorderExample.printCurrentSettings,
            ...
            ElevatedButton(
              onPressed:
                  SelectedTeacherDestinationBorderExample
                      .showHowToChangeBorderColor,
                ...
                border: Border.all(
                  color:
                      SimplifiedTimetableTheme
                          .selectedTeacherDestinationBorderColor,
                  width:
                      SimplifiedTimetableTheme
                          .selectedTeacherDestinationBorderWidth,
                ),
