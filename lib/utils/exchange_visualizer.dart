...
class ExchangeVisualizer {
  ...
  /// 교체 가능한 시간의 텍스트 스타일
  static TextStyle getExchangeableTextStyle(
    TimeSlot slot,
    List<ExchangeOption> exchangeOptions,
  ) {
    ExchangeOption? option = exchangeOptions.firstWhere(
  ...
  /// 교체 가능한 시간의 툴팁 텍스트
  static String getExchangeableTooltip(
    TimeSlot slot,
    List<ExchangeOption> exchangeOptions,
  ) {
    ExchangeOption? option = exchangeOptions.firstWhere(
  ...
  static Widget buildExchangeableCountWidget(int count) {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(Icons.swap_horiz, color: Colors.red.shade600, size: 16),
